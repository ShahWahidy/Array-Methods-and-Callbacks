...
*/
// receive an array -->fifaData
//method filter stage === final
function getFinals(data) {
   /* code here */
// console.log('inside the get final function')
   const filterdArray = data.filter(item => item.Stage === 'Final' )
   return filterdArray;
}
...
// two params array/getFinalscb
// method map 
// use a condtional if home > away => home win else away => win
function getWinners(array, getFinallscb) {
    /* code here */
    // return getFinallscb(array).map(item => item['Home Team Goals'] > item['Away Team Goals'] ? item['Home Team Name'] : item['Away Team Name'])
    const winners = getFinallscb(array).map(function(item){
...
// use map to go over one array, use index on the other array
function getWinnersByYear(array, getFinalscb, getYearscb, getWinnerscb) {
    /* code here */
   const winners = getWinnerscb(array, getFinalscb);
   const years  = getYearscb(array, getFinalscb)

   const results = winners.map(function(item, index){
...
*/
// getFinallscb
// method .reduce() / length of the array 
